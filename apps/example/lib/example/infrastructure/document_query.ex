defmodule Example.Infrastructure.DocumentQuery do
  ...
  # admits, the portions of a document, and the overrides an office
  # received. A rule is the `dynamic` the port's `scope` answered with. The
  ...
  @doc "Every portion of a document, which the banner comes from."
