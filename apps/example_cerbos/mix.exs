defmodule ExampleCerbos.MixProject do
  ...
  # the dump task raises. `muontrap` starts the sidecar the suite asks,
  # through the test tools. Every pin is exact. Versions verified against
  ...
  defp deps do
    [
      ...
      {:mediate_cerbos, sibling(:mediate_cerbos)},
      {:ecto, "3.14.2"},
      {:ecto_sql, "3.14.0"},
      {:postgrex, "0.22.4"},
  ...
  # https://hex.pm/api/packages/decimal on 2026-09-09. Mediate parses no
