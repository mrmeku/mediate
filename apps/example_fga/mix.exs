defmodule ExampleFga.MixProject do
  ...
  # the dump task raises. `muontrap` starts the server the suite asks,
  # through the adapter's test support. Every pin is exact. Versions
  ...
  defp deps do
    [
      ...
      {:mediate_fga, sibling(:mediate_fga)},
      {:ecto, "3.14.2"},
      {:ecto_sql, "3.14.0"},
      {:postgrex, "0.22.4"},
