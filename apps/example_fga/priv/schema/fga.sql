...
--
-- Name: mediate_fga_outbox; Type: TABLE; Schema: public; Owner: mediate_owner
--

CREATE TABLE public.mediate_fga_outbox (
    id bigint NOT NULL,
    object text NOT NULL
);


ALTER TABLE public.mediate_fga_outbox OWNER TO mediate_owner;

--
-- Name: mediate_fga_outbox_id_seq; Type: SEQUENCE; Schema: public; Owner: mediate_owner
--

CREATE SEQUENCE public.mediate_fga_outbox_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.mediate_fga_outbox_id_seq OWNER TO mediate_owner;

--
-- Name: mediate_fga_outbox_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mediate_owner
--

ALTER SEQUENCE public.mediate_fga_outbox_id_seq OWNED BY public.mediate_fga_outbox.id;


--
-- Name: mediate_relay_cursor; Type: TABLE; Schema: public; Owner: mediate_owner
--

CREATE TABLE public.mediate_relay_cursor (
    name text NOT NULL,
    "position" bigint NOT NULL
);


ALTER TABLE public.mediate_relay_cursor OWNER TO mediate_owner;
...
--
-- Name: mediate_fga_outbox id; Type: DEFAULT; Schema: public; Owner: mediate_owner
--

ALTER TABLE ONLY public.mediate_fga_outbox ALTER COLUMN id SET DEFAULT nextval('public.mediate_fga_outbox_id_seq'::regclass);
...
--
-- Name: mediate_fga_outbox mediate_fga_outbox_pkey; Type: CONSTRAINT; Schema: public; Owner: mediate_owner
--

ALTER TABLE ONLY public.mediate_fga_outbox
    ADD CONSTRAINT mediate_fga_outbox_pkey PRIMARY KEY (id);


--
-- Name: mediate_relay_cursor mediate_relay_cursor_pkey; Type: CONSTRAINT; Schema: public; Owner: mediate_owner
--

ALTER TABLE ONLY public.mediate_relay_cursor
    ADD CONSTRAINT mediate_relay_cursor_pkey PRIMARY KEY (name);
...
--
-- Name: TABLE mediate_fga_outbox; Type: ACL; Schema: public; Owner: mediate_owner
--

GRANT SELECT,INSERT,DELETE ON TABLE public.mediate_fga_outbox TO mediate_app;


--
-- Name: SEQUENCE mediate_fga_outbox_id_seq; Type: ACL; Schema: public; Owner: mediate_owner
--

GRANT USAGE ON SEQUENCE public.mediate_fga_outbox_id_seq TO mediate_app;


--
-- Name: TABLE mediate_relay_cursor; Type: ACL; Schema: public; Owner: mediate_owner
--

GRANT SELECT,INSERT,UPDATE ON TABLE public.mediate_relay_cursor TO mediate_app;
