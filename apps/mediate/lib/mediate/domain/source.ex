defmodule Mediate.Domain.Source do
  @moduledoc false
  # The root source of the value a Repo function got: a schema module, a
  # table name, or `nil`. Each shape answers with one part of itself:
  #
  # - a query, with its `from`, through a subquery
  # - a struct, with its schema
  # - a list, with its first element
  # - a changeset, with its data
  # - `{source, schema}`, with the schema
