defmodule Mediate.DependenciesTest do
  ...
  # What a production build installs and starts. That leaves out a tool
  # held to dev and test, one marked `runtime: false`, and one an adopter
  # can leave out.
