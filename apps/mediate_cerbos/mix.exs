defmodule Mediate.Cerbos.MixProject do
  use Mix.Project
  ...
  # postgrex serve the test run. muontrap starts the sidecar the suite asks,
  # through the test tools. stream_data carries no `only:` because the
  ...
  defp docs do
    [main: "readme", extras: ["README.md": [title: "Mediate Cerbos"]]]
  end
