defmodule Mediate.Conformance.Gen do
  @moduledoc """
  ...
  @spec object(World.t()) :: StreamData.t(Mediate.object())
  ...
  @spec strangers(World.t()) ::
          StreamData.t(%{subject: Mediate.subject(), stranger: Mediate.subject(), nobody: Mediate.subject()})
  ...
  @spec subject() :: StreamData.t(Mediate.subject())
  def subject do
