defmodule Mediate.Conformance.RepoCase.Fixture do
  @moduledoc false
  # The arguments `Mediate.Conformance.RepoCase` sweeps each surface
  # function with, on the protected schema.

  alias Mediate.Conformance.RepoCase.Protected
