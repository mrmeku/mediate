  ...
  defmodule Mediate.Credo.UnmediatedRepo do
    ...
    use Credo.Check,
      ...
      explanations: [
        ...
        every query and checks no decision. The seam is a second `use` after
        Ecto's:
    ...
    defp issue_for(ctx, meta) do
      format_issue(ctx,
        message: "use Ecto.Repo without use Mediate.Repo: every query on this repo runs unchecked.",
