defmodule Mediate.Dev.MixProject do
  use Mix.Project
  ...
  # library is not a dependency, so the library can take this
  # package in its test environment with no cycle. Every pin is exact.
  ...
  defp docs do
    [main: "readme", extras: ["README.md": [title: "Mediate dev"]]]
  end
