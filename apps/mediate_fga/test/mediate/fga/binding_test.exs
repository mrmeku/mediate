defmodule Mediate.Fga.BindingTest.Guarded do
  @moduledoc false
...
defmodule Mediate.Fga.BindingTest do
  use ExUnit.Case, async: false

  alias Mediate.Error
  alias Mediate.Fga.Binding
  alias Mediate.Fga.BindingTest.Guarded
  ...
  test "a module that is no tuple mapping is an invalid binding" do
    ...
    assert detail == "#{inspect(Folder)} is no Mediate.Fga.TupleMapping"
  end
  ...
  test "a module that is no guard is an invalid binding" do
    ...
    assert detail == "#{inspect(Folder)} is no Mediate.Fga.Guard"
  end
