defmodule Mediate.Postgres.Policy do
  @moduledoc """
  ...
  database renders runs over several lines. So the line that begins a
  policy holds a table, a name, and a command, and nothing else. Every
  other line belongs to the expression above it.
  """
  ...
  because the helpers write none. A policy of this package applies to
  every role and names the role it admits inside its expression.
  """
